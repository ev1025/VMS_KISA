...
log "fresh 큐 종료 대기"
while tmux has-session -t fresh 2>/dev/null; do sleep 120; done
T=$(date +%Y%m%d)
run_exp dfire_48k_$T           yolo11s dfire_yolo
run_exp dfire_48k_snowfull_$T  yolo11s fasdd_snowfog fasdd_yolo dfire_yolo
log "DFIRE QUEUE DONE"
